...
$(function() {
  ...
  function displayWindowSize() {
    ...
    if (w > 991) {
      ...
      $offCanvasNav.on(
        "click",
        "li a, li .menu-expand, .mega-dropdown-list .mega-title",
        function(e) {
          var $this = $(this);
          if (
            $this
      ...
      $offCanvasNavSubMenu
        .parent()
        .prepend('<span class="menu-expand d-lg-none"></span>');
  ...
  $(".product-active").slick({
    ...
    nextArrow:
      '<span class="next"><i class="mdi mdi-chevron-right"></i></span>',
    speed: 800,
    slidesToShow: 1,
    slidesToScroll: 1
  });
